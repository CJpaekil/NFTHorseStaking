...
export const getrpcURLWithChainId = (id) => {
    if (id === 1) return "https://mainnet.infura.io/v3/9aa3d95b3bc440fa88ea12eaa4456161"
    if (id === 137) return "https://polygon-rpc.com/"
    if (id === 43114) return "https://api.avax.network/ext/bc/C/rpc"
}